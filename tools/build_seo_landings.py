...
PAGES = [
    {
        ...
        "ko_description": "베트남 진출, 시장 진출 전략, 현지 운영 모델, 법인 설립, 인허가, 유통, 마케팅, 점포 운영까지 연결하는 Globos Holdings의 실행형 베트남 진출 지원.",
        ...
        "ko_h1": "베트남 진출은 전략보다 실행 구조가 먼저입니다.",
        "en_h1": "Vietnam market entry needs an execution structure, not just a strategy deck.",
        "ko_intro": "베트남 진출을 검토하는 기업은 시장성, 법인 설립, 인허가, 유통, 마케팅, 운영 인프라를 한 번에 판단해야 합니다. Globos Holdings는 2024년부터 베트남에서 실제 점포를 운영하며, 진출 전략을 현지 실행 구조로 연결합니다.",
        ...
        "ko_problem": "검색자는 베트남 진출 전략, 진출 컨설팅, 한국 기업 진출 사례, 실패 사례를 함께 찾습니다. 대부분의 실패는 시장조사 부족보다 현지 실행 구조 부재에서 시작됩니다.",
        ...
        "faqs_ko": [
            ["베트남 진출 전 가장 먼저 확인해야 할 것은 무엇인가요?", "시장 규모보다 먼저 현지에서 누가 운영하고, 어떤 법적·유통·마케팅 구조로 실행할지 확인해야 합니다."],
            ["Globos Holdings는 단순 컨설팅과 무엇이 다른가요?", "2024년부터 베트남에서 실제 점포를 운영하고 ERP, POS, 배달 앱 기반을 갖춘 실행형 운영 파트너입니다."],
            ["어떤 업종의 베트남 진출에 적합한가요?", "F&B, 프랜차이즈, 뷰티, 리테일, 이커머스, 유통형 브랜드에 적합합니다."],
            ["초기 상담에서 무엇을 준비해야 하나요?", "브랜드 소개, 목표 지역, 제품/서비스, 예상 투자 범위, 필요한 현지 기능을 준비하면 됩니다."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 법인 설립 절차, 비용, 자본금, 외투법인, 대표사무소, 사업자등록, 투자허가, 영업허가를 현지 사업 실행 관점에서 정리합니다.",
        ...
        "ko_h1": "베트남 법인 설립은 비용표보다 사업 구조 판단이 먼저입니다.",
        "en_h1": "Vietnam company registration starts with the business structure, not only the filing checklist.",
        "ko_intro": "법인 설립, 외투법인, 대표사무소, 사업자등록, 투자허가, 영업허가는 업종과 운영 방식에 따라 달라집니다. Globos Holdings는 법률 자문 연결과 현지 실행 준비를 함께 조율합니다.",
        ...
        "ko_problem": "검색자는 베트남 법인 설립 비용, 절차, 자본금, 대행업체를 찾지만 실제 판단은 어떤 형태로 사업을 운영할지에서 시작됩니다.",
        ...
        "faqs_ko": [
            ["베트남 법인 설립 비용은 고정인가요?", "아닙니다. 업종, 자본금, 외국인 투자 구조, 인허가 범위에 따라 달라집니다."],
            ["대표사무소와 법인은 어떻게 다르나요?", "대표사무소는 일반적으로 영업 활동이 제한되고, 법인은 매출 발생과 운영 범위가 더 넓습니다. 구체 판단은 업종별 검토가 필요합니다."],
            ["외투법인 설립에 자본금 기준이 있나요?", "업종과 허가 조건에 따라 요구되는 자본금 판단이 달라질 수 있습니다."],
            ["Globos Holdings가 법률 서비스를 직접 제공하나요?", "법률 판단은 현지 전문가와 조율하고, Globos Holdings는 사업 실행 구조와 운영 준비를 연결합니다."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 화장품 수출, 인증, 인허가, 제품등록, 위생허가, 라벨링, CFS, PIF, 통관, 유통업체 연결까지 시장 진입에 필요한 절차를 정리합니다.",
        ...
        "ko_h1": "베트남 화장품 진출은 제품등록, 라벨링, 통관, 유통을 함께 봐야 합니다.",
        "en_h1": "Vietnam cosmetics entry requires registration, labeling, customs, and distribution to move together.",
        "ko_intro": "화장품 수출은 인증 하나로 끝나지 않습니다. 성분, 제품등록, 라벨링, CFS/PIF, 수입자, 통관, 유통 채널을 동시에 준비해야 시장 출시 일정이 흔들리지 않습니다.",
        ...
        "ko_problem": "검색자는 베트남 화장품 수출, 인증, 인허가, 제품등록, 위생허가, 라벨링, 통관을 따로 검색하지만 실제 실행은 하나의 출시 흐름입니다.",
        ...
        "faqs_ko": [
            ["베트남 화장품 제품등록이 필요한가요?", "일반적으로 시장 판매 전 제품별 등록 또는 통지 절차 검토가 필요합니다."],
            ["화장품 라벨링도 현지화해야 하나요?", "네. 베트남 판매를 위해 현지 라벨 요건과 표시 문구를 검토해야 합니다."],
            ["CFS와 PIF가 필요한가요?", "제품 유형과 수출/등록 절차에 따라 CFS, PIF 등 문서 검토가 필요할 수 있습니다."],
            ["등록 후 유통까지 연결할 수 있나요?", "Globos Holdings는 등록 준비 이후 유통, 쇼피/틱톡샵, 마케팅 경로까지 연결해 검토합니다."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 식당 창업, 카페 창업, 한식당 창업, 외식업 진출, 프랜차이즈 창업을 점포 운영, 인력, POS, 배달, 공급망 관점에서 지원합니다.",
        ...
        "ko_h1": "베트남 식당·카페 창업은 오픈보다 운영 지속성이 핵심입니다.",
        "en_h1": "Vietnam restaurant and cafe entry is about operating durability, not only opening day.",
        "ko_intro": "베트남 F&B 진출은 입지, 인허가, 인력, 원부자재, POS, 배달, 마케팅, 점포 SOP가 맞물려야 합니다. Globos Holdings는 실제 점포 운영 경험을 기반으로 F&B 브랜드의 현지 실행 구조를 설계합니다.",
        ...
        "ko_problem": "검색자는 베트남 창업 현실, 식당 창업, 카페 창업, 한식당 창업, 프랜차이즈 창업을 찾지만 실제 병목은 오픈 후 운영 통제입니다.",
        ...
        "faqs_ko": [
            ["베트남 식당 창업에서 가장 큰 리스크는 무엇인가요?", "오픈 자체보다 인력, 원가, 공급망, 현장 관리, 배달 운영이 흔들리는 것이 더 큰 리스크입니다."],
            ["카페나 한식당도 지원 가능한가요?", "카페, 한식당, F&B 프랜차이즈 모두 운영 모델 검토가 가능합니다."],
            ["점포 운영을 직접 맡길 수 있나요?", "브랜드와 지역, 운영 범위에 따라 직접 운영, 공동 운영, 운영 컨설팅 구조를 검토합니다."],
            ["배달앱 운영도 포함되나요?", "배달 운영 흐름과 POS/주문/정산 루틴을 함께 검토합니다."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 쇼피 입점, 라자다 입점, 틱톡샵 입점, 온라인 판매, 셀러 운영, 상품 등록, 현지 마케팅, 물류·통관 연결을 지원합니다.",
        ...
        "ko_h1": "베트남 온라인 판매는 쇼피·라자다·틱톡샵 운영 구조부터 잡아야 합니다.",
        "en_h1": "Vietnam ecommerce entry starts with Shopee, Lazada, and TikTok Shop operating structure.",
        "ko_intro": "베트남 쇼피 입점, 라자다 판매, 틱톡샵 운영은 상품 등록만으로 끝나지 않습니다. 현지 셀러 구조, 콘텐츠, 광고, 물류, 통관, CS, 정산 루틴이 준비되어야 합니다.",
        ...
        "ko_problem": "검색자는 쇼피 베트남 판매, 베트남 쇼피 입점, 라자다 입점방법, 베트남 틱톡샵을 찾습니다. 이 검색어는 마케팅보다 판매 운영 의도가 강합니다.",
        ...
        "faqs_ko": [
            ["베트남 쇼피 입점은 한국 회사도 가능한가요?", "가능 여부는 셀러 구조, 현지 사업자, 상품군, 물류 방식에 따라 검토해야 합니다."],
            ["틱톡샵 베트남은 마케팅인가요 판매 채널인가요?", "둘 다입니다. 콘텐츠와 라이브커머스가 판매 운영과 연결되는 구조입니다."],
            ["라자다와 쇼피를 동시에 운영해야 하나요?", "상품군, 운영 인력, 마케팅 예산에 따라 우선순위를 정하는 것이 좋습니다."],
            ["Globos Holdings는 무엇을 지원하나요?", "입점 구조, 상품 등록, 현지 운영 루틴, 마케팅, 물류/통관 연결을 검토합니다."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 틱톡 마케팅, 틱톡 광고, 틱톡샵 대행, 쇼피 마케팅, SNS 마케팅, 인플루언서, 라이브커머스 실행 구조를 지원합니다.",
        ...
        "ko_h1": "베트남 마케팅은 틱톡, 쇼피, 인플루언서, 판매 전환까지 이어져야 합니다.",
        "en_h1": "Vietnam marketing must connect TikTok, Shopee, influencers, and sales conversion.",
        "ko_intro": "베트남 온라인 마케팅은 단순 광고 집행보다 채널별 판매 구조와 콘텐츠 현지화가 중요합니다. 틱톡 광고, 틱톡샵, 쇼피 캠페인, 인플루언서, 라이브커머스를 판매 운영과 연결해야 합니다.",
        ...
        "ko_problem": "검색자는 베트남 틱톡 마케팅, 틱톡 광고, 틱톡 대행, 쇼피 마케팅, 베트남 인플루언서 마케팅을 찾습니다. 각 채널은 별도 운영법이 필요합니다.",
        ...
        "faqs_ko": [
            ["베트남 틱톡 마케팅은 어떤 브랜드에 적합한가요?", "뷰티, F&B, 리테일, 소비재 브랜드처럼 시각 콘텐츠와 구매 전환이 연결되는 업종에 적합합니다."],
            ["쇼피 마케팅과 틱톡 마케팅은 같이 해야 하나요?", "제품군에 따라 다르지만, 인지도와 판매 전환을 연결하려면 함께 설계하는 경우가 많습니다."],
            ["인플루언서 섭외도 포함되나요?", "캠페인 목적과 예산에 따라 현지 인플루언서/콘텐츠 실행 구조를 검토합니다."],
            ["광고 대행만 가능한가요?", "단순 광고 집행보다 판매 운영, 콘텐츠, 채널 전략을 함께 봅니다."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 유통업체, 유통망, 유통채널, 통관, 통관대행, 통관 비용, 수입통관, 수입관세, 물류업체, 냉장 물류를 시장 진입 실행 관점에서 정리합니다.",
        ...
        "ko_h1": "베트남 유통은 업체 리스트가 아니라 통관부터 판매 채널까지의 구조입니다.",
        "en_h1": "Vietnam distribution is not a vendor list. It is the structure from customs to sales channels.",
        "ko_intro": "제품이 베트남에 들어오려면 통관, 수입자, 관세, 창고, 물류, 유통업체, 판매 채널이 연결되어야 합니다. Globos Holdings는 브랜드 진출 후 실제 판매가 가능한 실행 경로를 검토합니다.",
        ...
        "ko_problem": "검색자는 베트남 유통업체, 유통망, 통관대행, 수입관세, 물류업체를 찾습니다. 하지만 각 기능은 따로 움직이면 출시 일정과 원가가 흔들립니다.",
        ...
        "faqs_ko": [
            ["베트남 유통업체만 찾으면 충분한가요?", "아닙니다. 수입자, 통관, 관세, 물류, 판매 채널을 함께 검토해야 합니다."],
            ["통관 비용은 어떻게 정해지나요?", "제품군, HS 코드, 서류, 검사 여부, 물류 방식에 따라 달라질 수 있습니다."],
            ["냉장 물류나 식품 유통도 가능한가요?", "제품군과 지역에 따라 식자재/냉장/매장 공급망 검토가 가능합니다."],
            ["화장품 유통도 포함되나요?", "화장품은 인허가, 라벨링, 통관, 유통업체 검토가 함께 필요합니다."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 소싱 업체, 제조 소싱, 식자재 유통, 현지 공급망, 파트너 발굴, 점포 운영에 필요한 공급처 개발을 지원합니다.",
        ...
        "ko_h1": "베트남 소싱은 가격 비교가 아니라 운영 가능한 공급망을 만드는 일입니다.",
        "en_h1": "Vietnam sourcing is not only price comparison. It is building an operating supply chain.",
        "ko_intro": "소싱은 제조공장이나 업체 리스트를 찾는 데서 끝나지 않습니다. 품질, 납기, 통관, 물류, 매장 공급, 정산, 지속 운영 가능성을 함께 봐야 합니다.",
        ...
        "ko_problem": "검색자는 베트남 소싱, 소싱 업체, 제조공장, 식자재 유통을 찾습니다. 하지만 브랜드 운영에는 실제로 납품 가능한 공급망이 필요합니다.",
        ...
        "services_ko": ["제품/브랜드 운영에 필요한 공급처 조건 정리", "제조, 식자재, 부자재, 물류 연결 가능성 검토", "점포 운영, 유통, 이커머스 판매와 연결되는 공급망 설계"],
        ...
        "faqs_ko": [
            ["베트남 소싱 업체 리스트를 제공하나요?", "단순 리스트보다 제품 조건, 품질, 납기, 물류 가능성을 기준으로 검토합니다."],
            ["식자재 유통도 소싱에 포함되나요?", "F&B 운영에 필요한 식자재, 부자재, 매장 공급망을 함께 검토할 수 있습니다."],
            ["제조 소싱과 유통 소싱은 어떻게 다른가요?", "제조 소싱은 생산처 중심이고, 유통 소싱은 판매·운영 채널에 맞는 공급 구조 중심입니다."],
            ["소싱 후 운영까지 연결되나요?", "네. 공급처 개발은 점포 운영, 유통, 물류, 이커머스 판매와 연결해 봐야 합니다."],
        ],
        "faqs_en": [
...
def render_page(page: dict, lang: str) -> str:
    ...
    proof_text = (
        "Globos Holdings는 2024년 베트남에서 시작해 현재 8개 점포를 운영하고, 올해 20개 점포까지 확장을 목표로 합니다. in-house ERP, SaaS POS, 배달 앱 기반을 실제 운영 구조와 연결합니다."
        if is_ko
        else "Globos Holdings began Vietnam operations in 2024, currently operates 8 stores, and targets 20 stores this year. in-house ERP, SaaS POS, and delivery app infrastructure are connected to the operating model."
    )
    can_do = "Globos Holdings가 지원하는 일" if is_ko else "What Globos Holdings supports"
    search_problem = "검색자가 실제로 찾는 문제" if is_ko else "The problem searchers are actually trying to solve"
    faq_title = "자주 묻는 질문" if is_ko else "Frequently Asked Questions"
    cta_title = "베트남 실행 병목을 먼저 공유하세요." if is_ko else "Share the Vietnam execution bottleneck first."
    cta_body = (
        "브랜드, 제품군, 목표 지역, 현재 준비 단계, 가장 막히는 지점을 보내주시면 다음 실행 경로를 정리합니다."
        if is_ko
