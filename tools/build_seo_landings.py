...
PAGES = [
    {
        ...
        "ko_description": "베트남 진출, 베트남 시장 진출 전략, 법인 설립, 인허가, 유통, 마케팅, 점포 운영을 현지 실행 구조로 연결하는 Globos Holdings 실행 지원.",
        ...
        "ko_h1": "베트남 진출, 전략보다 실행 구조",
        "en_h1": "Vietnam market entry needs an execution structure, not just a strategy deck.",
        "ko_intro": "시장성, 법인 설립, 인허가, 유통, 마케팅, 운영 인프라 동시 판단. 2024년부터 베트남 점포 운영 기반의 현지 실행 설계.",
        ...
        "ko_problem": "주요 검색 의도: 베트남 진출 전략, 진출 컨설팅, 한국 기업 진출 사례, 실패 사례. 핵심 병목: 시장조사보다 현지 실행 구조 부재.",
        ...
        "faqs_ko": [
            ...
            ["초기 상담 준비 자료", "브랜드 소개, 목표 지역, 제품/서비스, 예상 투자 범위, 필요한 현지 기능."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_description": "베트남 법인 설립 절차, 비용, 자본금, 외투법인, 대표사무소, 사업자등록, 투자허가, 영업허가를 사업 실행 관점으로 정리한 안내.",
        ...
        "ko_h1": "베트남 법인 설립, 비용표보다 사업 구조",
        "en_h1": "Vietnam company registration starts with the business structure, not only the filing checklist.",
        "ko_intro": "법인 설립, 외투법인, 대표사무소, 사업자등록, 투자허가, 영업허가의 업종·운영 방식별 판단. 법률 자문 연결과 현지 실행 준비 병행 조율.",
        ...
        "ko_problem": "주요 검색 의도: 베트남 법인 설립 비용, 절차, 자본금, 대행업체. 실제 출발점: 사업 운영 형태와 허가 범위.",
    ...
    },
    {
        ...
        "ko_intro": "인증 하나로 끝나지 않는 화장품 수출. 성분, 제품등록, 라벨링, CFS/PIF, 수입자, 통관, 유통 채널의 동시 준비.",
        ...
        "ko_problem": "주요 검색 의도: 베트남 화장품 수출, 인증, 인허가, 제품등록, 위생허가, 라벨링, 통관. 실제 실행: 하나의 출시 흐름.",
        ...
        "faqs_ko": [
            ...
            ["등록 이후 유통 연결", "등록 준비 이후 유통, 쇼피/틱톡샵, 마케팅 경로 연결 검토."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_h1": "베트남 식당·카페 창업, 오픈보다 운영 지속성",
        "en_h1": "Vietnam restaurant and cafe entry is about operating durability, not only opening day.",
        "ko_intro": "입지, 인허가, 인력, 원부자재, POS, 배달, 마케팅, 점포 SOP의 결합. 실제 점포 운영 경험 기반의 F&B 현지 실행 구조.",
        ...
        "ko_problem": "주요 검색 의도: 베트남 창업 현실, 식당 창업, 카페 창업, 한식당 창업, 프랜차이즈 창업. 실제 병목: 오픈 후 운영 통제.",
        ...
        "faqs_ko": [
            ...
            ["카페·한식당 지원 범위", "카페, 한식당, F&B 프랜차이즈 운영 모델 검토."],
    ...
    },
    {
        ...
        "ko_description": "베트남 쇼피 입점, 라자다 입점, 틱톡샵 입점, 온라인 판매, 셀러 운영, 상품 등록, 현지 마케팅, 물류·통관 연결 지원.",
        ...
        "ko_intro": "상품 등록만으로 끝나지 않는 쇼피, 라자다, 틱톡샵 운영. 현지 셀러 구조, 콘텐츠, 광고, 물류, 통관, CS, 정산 루틴 필요.",
        ...
        "ko_problem": "주요 검색 의도: 쇼피 베트남 판매, 베트남 쇼피 입점, 라자다 입점방법, 베트남 틱톡샵. 핵심 의도: 마케팅보다 판매 운영.",
        ...
        "faqs_ko": [
            ...
            ["라자다·쇼피 동시 운영", "상품군, 운영 인력, 마케팅 예산 기준 우선순위 설정."],
            ["Globos Holdings 지원 범위", "입점 구조, 상품 등록, 현지 운영 루틴, 마케팅, 물류/통관 연결 검토."],
        ],
        "faqs_en": [
    ...
    },
    {
        ...
        "ko_intro": "단순 광고 집행보다 채널별 판매 구조와 콘텐츠 현지화. 틱톡 광고, 틱톡샵, 쇼피 캠페인, 인플루언서, 라이브커머스의 판매 운영 연결.",
        ...
        "ko_problem": "주요 검색 의도: 베트남 틱톡 마케팅, 틱톡 광고, 틱톡 대행, 쇼피 마케팅, 베트남 인플루언서 마케팅. 채널별 운영법 필요.",
        ...
        "faqs_ko": [
            ...
            ["인플루언서 섭외 포함 범위", "캠페인 목적과 예산 기준 현지 인플루언서/콘텐츠 실행 구조 검토."],
    ...
    },
    {
        ...
        "ko_h1": "베트남 유통, 업체 리스트보다 통관·판매 채널 구조",
        "en_h1": "Vietnam distribution is not a vendor list. It is the structure from customs to sales channels.",
        "ko_intro": "통관, 수입자, 관세, 창고, 물류, 유통업체, 판매 채널의 연결. 브랜드 진출 후 실제 판매 가능한 실행 경로 검토.",
        ...
        "ko_problem": "주요 검색 의도: 베트남 유통업체, 유통망, 통관대행, 수입관세, 물류업체. 핵심 병목: 기능 분리로 인한 일정·원가 흔들림.",
        ...
        "faqs_ko": [
            ...
            ["냉장 물류·식품 유통", "제품군과 지역 기준 식자재/냉장/매장 공급망 검토."],
    ...
    },
    {
        ...
        "ko_h1": "베트남 소싱, 가격 비교보다 운영 가능한 공급망",
        "en_h1": "Vietnam sourcing is not only price comparison. It is building an operating supply chain.",
        "ko_intro": "제조공장이나 업체 리스트를 넘어선 품질, 납기, 통관, 물류, 매장 공급, 정산, 지속 운영 가능성 검토.",
        ...
        "ko_problem": "주요 검색 의도: 베트남 소싱, 소싱 업체, 제조공장, 식자재 유통. 브랜드 운영 핵심: 실제 납품 가능한 공급망.",
        ...
        "faqs_ko": [
            ...
            ["제조 소싱과 유통 소싱 차이", "제조 소싱은 생산처 중심. 유통 소싱은 판매·운영 채널에 맞춘 공급 구조 중심."],
...
def render_page(page: dict, lang: str) -> str:
    ...
    proof_text = (
        "2024년 베트남 운영 개시. 현재 8개 점포 운영, 올해 20개 점포 목표. in-house ERP, SaaS POS, 배달 앱 기반의 실제 운영 구조."
        if is_ko
    ...
    cta_title = "베트남 실행 병목 공유" if is_ko else "Share the Vietnam execution bottleneck first."
    cta_body = (
        "브랜드, 제품군, 목표 지역, 현재 준비 단계, 핵심 병목 전달. 다음 실행 경로 정리."
        if is_ko
